...
{
    public class DishReactivate
    {
        private readonly ILogger<DishReactivate> _logger;
        private readonly IDishRepository _dishRepository;
        private readonly IAuthzService _authz;

        public DishReactivate(ILogger<DishReactivate> logger, IDishRepository dishRepository, IAuthzService authz)
        {
            _logger = logger;
        ...
        [Function(nameof(DishReactivate))]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "patch", Route = "families/{familyId}/dishes/{dishId}/reactivate")] HttpRequest req,
            string familyId,
            string dishId)
        {
